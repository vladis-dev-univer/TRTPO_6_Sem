...
<div class="wrapper">
    <custag:header/>
    <c:set var="pageName" value="/admin/profile.html"/>
        ...
        <div class="profile">
            ...
            <div class="buttons-profile">
                <table>
                    <tr>
                        <td>
                            <c:url value="/admin/user/list.html" var="userEditUrl"/>
                            <form class="public" action="${userEditUrl}" method="post">
                                <input type="submit" value="<fmt:message key="users.name" bundle="${ rb }"/>">
                            </form>
                        </td>
                        <td>
